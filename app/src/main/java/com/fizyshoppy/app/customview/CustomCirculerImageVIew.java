package com.fizyshoppy.app.customview;
...
public class CustomCirculerImageVIew extends AppCompatImageView {
    ...
    public CustomCirculerImageVIew(Context context) {
        super(context);

        init();
    }

    public CustomCirculerImageVIew(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomCirculerImageVIew(Context context, AttributeSet attrs, int defStyle) {
