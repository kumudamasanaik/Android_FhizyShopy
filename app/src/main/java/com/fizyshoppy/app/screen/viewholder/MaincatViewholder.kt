...
class MaincatViewholder(override val containerView: View, val clickListener: IAdapterClickListener, var adapterType: String) : BaseViewholder(containerView), LayoutContainer {
            ...
            if (Validation.isValidObject(clickListener)) {
                itemView.setOnClickListener {
                    if (Validation.isValidString(adapterType)) {
                        clickListener.onAdapterClick(category, pos, containerView, adapterType)
                    }
                }
            }
